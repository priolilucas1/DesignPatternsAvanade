...
namespace Workbench.Linq.Extensions.Tests
{
    public class DistinctExtensionsTests
    {
        ...
        public void ListagemComItensRepetidosComparecaoSimples()
        {
            ...
            {
                new PessoaFisica() { Nome = "Lucas Prioli", NomeMae = "Michelle", CPF = "111.111.111-11" },
                new PessoaFisica() { Nome = "Lucas Prioli", NomeMae = "Ana", CPF = "111.111.111-11" },
                new PessoaFisica() { Nome = "Lucas Prioli", NomeMae = "Maria", CPF = "222.222.222-22" }
            };
